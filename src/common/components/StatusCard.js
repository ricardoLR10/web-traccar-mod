...
const StatusCard = ({ deviceId, position, onClose, disableActions, desktopPadding = 0 }) => {
  ...
  const positionItems = useAttributePreference('positionItems', 'fixTime,speed,ignition,batteryLevel,motion,address,totalDistance,course'); // fixTime,speed,ignition,batteryLevel,motion,address,totalDistance,course
